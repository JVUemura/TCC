package AERO_model
  package DFIG_model
    ...
    model MIT
      ...
      parameter Boolean RP = true "Inicialização do modelo" annotation(
        Dialog(group = "Dados de inicialização"));
...
// Sinal para a fonte de corrente:
      ...
      alpha = Park1.theta;
      annotation(
        Icon(graphics = {Rectangle(lineColor = {0, 0, 255}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-100, 100}, {100, -100}}), Text(origin = {-1, 0}, rotation = 180, textColor = {0, 0, 255}, extent = {{-44, 37}, {44, -37}}, textString = "CTRL
DFIG"), Text(origin = {-90, -71}, textColor = {0, 0, 255}, extent = {{-6, 15}, {6, -15}}, textString = "Wrm"), Text(origin = {-31, -154}, textColor = {255, 255, 255}, extent = {{-11, 6}, {11, -6}}, textString = "Qesp"), Text(origin = {-81, 1}, textColor = {0, 0, 255}, extent = {{-17, 17}, {17, -17}}, textString = "thetaE_PLL"), Text(origin = {-85, 79}, textColor = {0, 0, 255}, extent = {{-13, 11}, {13, -11}}, textString = "Vqs_PLL"), Text(origin = {-41, -89}, textColor = {0, 0, 255}, extent = {{-9, 7}, {9, -7}}, textString = "Te"), Text(origin = {40, -89}, textColor = {0, 0, 255}, extent = {{-10, 7}, {10, -7}}, textString = "Qs"), Text(origin = {-87, 41}, textColor = {0, 0, 255}, extent = {{-11, 9}, {11, -9}}, textString = "We_PLL")}, coordinateSystem(extent = {{-100, -100}, {100, 100}})),
    ...
    connect(tpark.qd0[2], pi.u) annotation(
      ...
      annotation(
        Icon(graphics = {Rectangle(lineColor = {0, 0, 255}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-100, 100}, {100, -100}}), Text(origin = {1, -4}, textColor = {0, 0, 255}, extent = {{-45, 32}, {45, -32}}, textString = "PLL"), Text(origin = {78, 62}, textColor = {0, 0, 255}, extent = {{-18, 18}, {18, -18}}, textString = "VqPll"), Text(origin = {81, -1}, textColor = {0, 0, 255}, extent = {{-19, 11}, {19, -11}}, textString = "WePll"), Text(origin = {76, -60}, textColor = {0, 0, 255}, extent = {{-24, 20}, {24, -20}}, textString = "ThetaPll")}, coordinateSystem(extent = {{-100, -100}, {100, 100}})),
        experiment(StartTime = 0, StopTime = 1, Tolerance = 1e-06, Interval = 0.002),
        Diagram);
    end PLL;
  ...
  connect(rV_comZeros.Te, control1.Te_esp) annotation(
        Line(points = {{10, 26}, {10, 14}}, color = {0, 0, 127}));
    protected
      annotation(
        experiment(StartTime = 0, StopTime = 10, Tolerance = 1e-06, Interval = 0.000833333),
        Diagram(coordinateSystem(extent = {{-100, -100}, {100, 100}})));
    end controleDFIG_comzeros;
    
    model controleDFIG_semzeros
      extends Modelica.Icons.Example;
      import pi = Modelica.Constants.pi;
      Modelica.Blocks.Math.Add add annotation(
        Placement(visible = true, transformation(origin = {-46, 40}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
